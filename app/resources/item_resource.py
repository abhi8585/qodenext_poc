...
class ItemResource(Resource):
    def get(self):
        ...
        if serial_number:
            ...
            item_exist = mysql_client.select(table_name='product',filter_condition=f"where serial_number = '{serial_number}'")
            if item_exist:
            ...
            return {'message': 'No serial_number parameter provided'}, 400
